...
public class SplashActivity extends AppCompatActivity {
    ...
    private void localize() {
        ...
        final LocalizeKNN localizer = new LocalizeKNN(this);
                ...
                obj, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            Log.d("point best x y", String.format("%f %f", best.x, best.y));
        ...
        VolleySingleton.getInstance(getApplicationContext()).addToRequestQueue(apiRequest);
    }

    private void goToMainActivity(String floor, PointF xy) {
        Intent main = new Intent();
        main.setClass(getApplicationContext(), MainActivity.class);
        main.putExtra("floor", floor);
        main.putExtra("pointx", xy.x);
        main.putExtra("pointy", xy.y);
        startActivity(main);
    }
}
